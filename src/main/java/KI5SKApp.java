...
public class KI5SKApp {
    ...
    public static void initStore() {
        List<String> storeNames = Arrays.asList("📍 쿵후 마라탕 성수점", "📍 BBQ 성수3점", "📍 제주국수", "📍 산들김밥", "📍 엉터리생고기", "📍 코끼리베이글", "📍 자연도 소금빵", "📍 써브웨이");
        List<String> imagePaths = Arrays.asList("store/maratang.png", "store/bbq.jpeg", "store/jeju.jpg", "store/sandle.jpg","store/ungseang.jpeg","store/bagle.jpeg", "store/bbang.jpeg", "store/subway.jpeg");
